...
public:
    ...
    virtual bool                                                   create(fpx_t                                    width,
                                                                          ...
                                                                          Ui::Backend::Window::NativeWindowHandle  parentWindow,
                                                                          const std::string &                      title) = 0;
    [[nodiscard]] virtual bool                                     isValid() const                   = 0;
    [[nodiscard]] virtual Ui::Backend::Window::NativeWindowHandle  nativeHandle() const              = 0;
    [[nodiscard]] virtual Ui::Backend::Window::NativeDisplayHandle nativeDisplay() const             = 0;
