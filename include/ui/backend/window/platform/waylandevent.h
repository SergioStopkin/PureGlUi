...
#include "ui/backend/window/platform/waylandwindow.h"
#include "ui/config.h"
 ...
 *
 * Implements Ui::Backend::Window::IEventOS for Wayland/Linux platform.
 * Uses wl_pointer and wl_keyboard listeners to receive events.
 * Events are queued internally and returned via pollEvent().
 */
class WaylandEvent final : public Ui::Backend::Window::IEventOS {
public:
    ...
    bool hasPendingEvents(Ui::Backend::Window::IWindow & window) const override
    {
