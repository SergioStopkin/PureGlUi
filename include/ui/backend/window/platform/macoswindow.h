...
#include "ui/backend/window/platform/macosevent.h"
 ...
 *
 * Implements Ui::Backend::Window::IWindow for macOS using Cocoa for window management and NSOpenGL for OpenGL context.
 */
