...
#include "ui/backend/window/icontext.h"
 ...
 */
class EglContext final : public Ui::Backend::Window::IContext {
public:
    EglContext() = default;
     ...
     */
    static std::unique_ptr<EglContext> create(Ui::Backend::Window::NativeDisplayHandle display, EglPlatform platform)
    {
     ...
     */
    bool init(Ui::Backend::Window::NativeDisplayHandle display) override { return init(display, EglPlatform::X11); }
    ...
    bool initWithCachedConfig(EGLDisplay                               eglDisplay,
                              ...
                              bool                                     hasMsaa,
                              bool                                     hasAlpha,
                              Ui::Backend::Window::NativeDisplayHandle display)
    {
     ...
     * @param platform Platform type
     */
    bool init(Ui::Backend::Window::NativeDisplayHandle display, EglPlatform platform)
    {
#ifdef __linux__
        if (display == nullptr) {
     ...
     */
    bool createSurface(Ui::Backend::Window::NativeWindowHandle window, int width = 0, int height = 0)
    {
#ifdef __linux__
    ...
    bool createSurface(Ui::Backend::Window::NativeWindowHandle window) override { return createSurface(window, 0, 0); }
...
private:
    ...
    Ui::Backend::Window::NativeDisplayHandle m_nativeDisplay = nullptr;
