...
#error "No single-channel texture format available (need GL_LUMINANCE or GL_RED)"
            ...
            auto init_gl_resources = [&]() {
                ...
                const GLuint vs = Ui::Backend::Gl::Util::compileShader(GL_VERTEX_SHADER,
                                                                       vs_src,
                                                                       "[Font] Vertex shader error: ");
                const GLuint fs = Ui::Backend::Gl::Util::compileShader(GL_FRAGMENT_SHADER,
                                                                       fs_src,
                ...
                f->program = Ui::Backend::Gl::Util::linkProgram(vs, fs, "[Font] Shader link error: ");
                if (f->program == 0) {
                    return;
                }
                ...
                Ui::Backend::Gl::Util::createPosUvVao(f->vao, f->vbo);
            };
...
private:
    ...
    void releaseFontResources(font_rec_t & fr)
    {
        ...
        Ui::Backend::Gl::Util::deleteTexture(fr.atlas_tex);
        Ui::Backend::Gl::Util::deleteVertexArray(fr.vao);
        Ui::Backend::Gl::Util::deleteBuffer(fr.vbo);
        Ui::Backend::Gl::Util::deleteProgram(fr.program);
    }
