 ...
 * @brief Exhaustive guard for Ui::Res::Store::disableUnhandled - the recursive
 *        "collapse dead menu nodes" pass. Positive/negative cases across menu
 *        items (leaves), submenus, and top-menu entries, plus nesting,
 *        separators, pre-disabled nodes, and degenerate inputs. Pure C++ - no
 *        GL/X11, builds synthetic menu_t trees directly.
 */
